    ...
    return (
        <section className="max-w-5xl mx-auto">
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[16px] max-w-3xl">Create imaginative and visually stunning images through DALL-E model by OpenAI and share them with the community</p>
            </div>
